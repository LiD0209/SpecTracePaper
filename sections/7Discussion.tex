...
\textbf{Test generation is incomplete.}
The validation agent cannot guarantee path coverage. A failed test attempt may
reflect a missing harness, hidden deployment condition, or incomplete
environment rather than absence of a defect. \tool{} therefore treats unreached
paths as unresolved evidence, not as false positives or true negatives.
...
\tool{} may discover implementation deviations in deployed security protocols.
