...
The subjects include widely deployed TLS, QUIC, MQTT, and CoAP stacks and
libraries~\cite{openssl,wolfssl,mbedtls,boringssl,quiche,ngtcp2,mosquitto,wolfmqtt,libcoap}.
